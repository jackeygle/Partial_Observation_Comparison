...
from methods.enkf.lcskf.checks.compare_joint_uncertainty import accumulate, finalize
from methods.enkf.lcskf.filter import load_models, run_file
    ...
    for (name, criterion, factor_scale, diagonal_scale, mode, blind_gamma,
        ...
        if args.export_npz:
            ...
            (export_dir / f"est_{day}.source.json").write_text(json.dumps({
                "variant": label, "produced_by": "methods.enkf.lcskf.checks.eval_sequential",
